...
const Navbar = () => {
  ...
  return (
    <>
    <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-500 fixed top-0 left-0 right-0 z-50 
        ${
            sticky?
  ...
  <div className="navbar-start">
    ...
    <a className=" text-2xl font-bold text-cyan-500">BookStore</a>
  </div>
